...
- **Команда цифровой трансформации розничного бизнеса.** В ней 10 человек. https://pictures.s3.yandex.net/resources/image_23_1732290315.png
...
1. Проект этого спринта вы будете сдавать в Git-репозитории. Создайте публичный репозиторий в GitHub. Назовите его «architecture-standart».
...
## Дополнительные условия выполнения заданий
* Это учебный проект на курсе **Архитектура ПО**
* Выполненные задания должны быть понятны новичку в этой теме.